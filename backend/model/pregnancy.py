...
with open('../pregnent.pkl', 'rb') as f:
    model = pickle.load(f)

data = pd.read_csv('../data/pregnentByme.csv')

def predict_pregnancy(input_generic_name, input_dosage):
    """
...
if __name__ == "__main__":
    ...
    # Get prediction
    prediction = predict_pregnancy(generic_name, dosage)
